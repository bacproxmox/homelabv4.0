...
const mockGithubRepos = (): GithubRepoVersion[] => [
  ...
  },
  {
    id: 400,
    name: 'homelabv4.0',
    fullName: 'bacproxmox/homelabv4.0',
    owner: 'bacproxmox',
    repo: 'homelabv4.0',
    htmlUrl: 'https://github.com/bacproxmox/homelabv4.0',
    cloneUrl: 'https://github.com/bacproxmox/homelabv4.0.git',
    defaultBranch: 'main',
    private: false,
    updatedAt: new Date().toISOString(),
    version: '4.0',
    versionLabel: 'Homelabv4.0'
  }
];

const mockGithubPackage = (): GithubPackageSelection => ({
  localPath: 'C:\\Users\\Burhan\\Documents\\Homelabv4\\homelabv4.0.zip',
  fileName: 'homelabv4.0.zip',
...
export function installBrowserMock(): void {
  ...
  const api: HomelabApi = {
    ...
    uploadGithubReleaseAsset: async (request) => ({
      ...
      assetUrl: `https://github.com/${request.owner}/${request.repo}/releases/download/${request.tagName}/homelabv4.0.zip`,
      browserDownloadUrl: `https://github.com/${request.owner}/${request.repo}/releases/download/${request.tagName}/homelabv4.0.zip`,
      assetName: 'homelabv4.0.zip',
