...
- GitHub Packages panel for scanning `bacproxmox/homelabv*` repositories, creating a version repository such as `homelabv4.0`, and committing ZIP contents into it.
...
github.com/bacproxmox/homelabv4.0
```

Matching repositories appear as selectable labels like `Homelabv2.4.5`. Select a source package such as `homelabv4.0.zip`, enter or save a GitHub token with repository creation and contents access, then publish the ZIP contents into the selected or newly named repository.
